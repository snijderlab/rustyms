...
impl Model {
    ...
    pub fn all() -> Self {
        Self {
            a: (Location::SkipNC(1, 1), vec![NeutralLoss::Water]),
            b: (Location::SkipNC(1, 1), vec![NeutralLoss::Water]),
            c: (Location::SkipNC(1, 1), vec![NeutralLoss::Water]),
            d: (Location::SkipNC(1, 1), vec![NeutralLoss::Water]),
            v: (Location::SkipNC(1, 1), vec![NeutralLoss::Water]),
            w: (Location::SkipNC(1, 1), vec![NeutralLoss::Water]),
            x: (Location::SkipNC(1, 1), vec![NeutralLoss::Water]),
            y: (Location::SkipNC(1, 1), vec![NeutralLoss::Water]),
            z: (Location::SkipNC(1, 1), vec![NeutralLoss::Water]),
