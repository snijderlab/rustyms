...
std::iter::once(lock_AnarhichasMinor())
.chain(std::iter::once(lock_BosTaurus()))
...
.chain(std::iter::once(lock_CarcharhinusPlumbeus()))
.chain(std::iter::once(lock_CercocebusAtys()))
.chain(std::iter::once(lock_ChaenocephalusAceratus()))
.chain(std::iter::once(lock_CyprinusCarpio()))
.chain(std::iter::once(lock_DanioRerio()))
.chain(std::iter::once(lock_DicentrarchusLabrax()))
.chain(std::iter::once(lock_EquusCaballus()))
.chain(std::iter::once(lock_FelisCatus()))
.chain(std::iter::once(lock_GadusMorhua()))
.chain(std::iter::once(lock_GallusGallus()))
.chain(std::iter::once(lock_GasterosteusAculeatus()))
.chain(std::iter::once(lock_GinglymostomaCirratum()))
.chain(std::iter::once(lock_GorillaGorilla()))
.chain(std::iter::once(lock_GorillaGorillaGorilla()))
.chain(std::iter::once(lock_HeterodontusFrancisci()))
.chain(std::iter::once(lock_HomoSapiens()))
.chain(std::iter::once(lock_HydrolagusColliei()))
.chain(std::iter::once(lock_HylobatesLar()))
.chain(std::iter::once(lock_IctalurusPunctatus()))
.chain(std::iter::once(lock_LemurCatta()))
.chain(std::iter::once(lock_LeucorajaErinacea()))
.chain(std::iter::once(lock_MacacaArctoides()))
.chain(std::iter::once(lock_MacacaCyclopis()))
...
.chain(std::iter::once(lock_MacacaSilenus()))
.chain(std::iter::once(lock_MacacaThibetana()))
.chain(std::iter::once(lock_MonodelphisDomestica()))
...
.chain(std::iter::once(lock_NototheniaCoriiceps()))
...
.chain(std::iter::once(lock_OryctolagusCuniculusAlgirus()))
.chain(std::iter::once(lock_OryctolagusCuniculusCuniculus()))
.chain(std::iter::once(lock_OvisAries()))
.chain(std::iter::once(lock_PanTroglodytes()))
.chain(std::iter::once(lock_PapioAnubisAnubis()))
.chain(std::iter::once(lock_PongoAbelii()))
.chain(std::iter::once(lock_PongoPygmaeus()))
.chain(std::iter::once(lock_ProtopterusAethiopicus()))
.chain(std::iter::once(lock_RajaEglanteria()))
.chain(std::iter::once(lock_RattusNorvegicus()))
.chain(std::iter::once(lock_RattusRattus()))
.chain(std::iter::once(lock_SalmoSalar()))
.chain(std::iter::once(lock_SalmoTrutta()))
.chain(std::iter::once(lock_SeriolaQuinqueradiata()))
.chain(std::iter::once(lock_SinipercaChuatsi()))
.chain(std::iter::once(lock_SusScrofa()))
.chain(std::iter::once(lock_TrematomusBernacchii()))
.chain(std::iter::once(lock_VicugnaPacos()))
.chain(std::iter::once(lock_XenopusLaevisOrGilli()))
}
...
rayon::iter::once(lock_AnarhichasMinor())
.chain(rayon::iter::once(lock_BosTaurus()))
...
.chain(rayon::iter::once(lock_CarcharhinusPlumbeus()))
.chain(rayon::iter::once(lock_CercocebusAtys()))
.chain(rayon::iter::once(lock_ChaenocephalusAceratus()))
.chain(rayon::iter::once(lock_CyprinusCarpio()))
.chain(rayon::iter::once(lock_DanioRerio()))
.chain(rayon::iter::once(lock_DicentrarchusLabrax()))
.chain(rayon::iter::once(lock_EquusCaballus()))
.chain(rayon::iter::once(lock_FelisCatus()))
.chain(rayon::iter::once(lock_GadusMorhua()))
.chain(rayon::iter::once(lock_GallusGallus()))
.chain(rayon::iter::once(lock_GasterosteusAculeatus()))
.chain(rayon::iter::once(lock_GinglymostomaCirratum()))
.chain(rayon::iter::once(lock_GorillaGorilla()))
.chain(rayon::iter::once(lock_GorillaGorillaGorilla()))
.chain(rayon::iter::once(lock_HeterodontusFrancisci()))
.chain(rayon::iter::once(lock_HomoSapiens()))
.chain(rayon::iter::once(lock_HydrolagusColliei()))
.chain(rayon::iter::once(lock_HylobatesLar()))
.chain(rayon::iter::once(lock_IctalurusPunctatus()))
.chain(rayon::iter::once(lock_LemurCatta()))
.chain(rayon::iter::once(lock_LeucorajaErinacea()))
.chain(rayon::iter::once(lock_MacacaArctoides()))
.chain(rayon::iter::once(lock_MacacaCyclopis()))
...
.chain(rayon::iter::once(lock_MacacaSilenus()))
.chain(rayon::iter::once(lock_MacacaThibetana()))
.chain(rayon::iter::once(lock_MonodelphisDomestica()))
...
.chain(rayon::iter::once(lock_NototheniaCoriiceps()))
...
.chain(rayon::iter::once(lock_OryctolagusCuniculusAlgirus()))
.chain(rayon::iter::once(lock_OryctolagusCuniculusCuniculus()))
.chain(rayon::iter::once(lock_OvisAries()))
.chain(rayon::iter::once(lock_PanTroglodytes()))
...
.chain(rayon::iter::once(lock_ProtopterusAethiopicus()))
.chain(rayon::iter::once(lock_RajaEglanteria()))
.chain(rayon::iter::once(lock_RattusNorvegicus()))
.chain(rayon::iter::once(lock_RattusRattus()))
.chain(rayon::iter::once(lock_SalmoSalar()))
.chain(rayon::iter::once(lock_SalmoTrutta()))
.chain(rayon::iter::once(lock_SeriolaQuinqueradiata()))
.chain(rayon::iter::once(lock_SinipercaChuatsi()))
.chain(rayon::iter::once(lock_SusScrofa()))
.chain(rayon::iter::once(lock_TrematomusBernacchii()))
.chain(rayon::iter::once(lock_VicugnaPacos()))
.chain(rayon::iter::once(lock_XenopusLaevisOrGilli()))
}
